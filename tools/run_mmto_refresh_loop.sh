...
echo "BEST_GUARD_TEACHER_MATCH_DROP_PCT=$BEST_GUARD_TEACHER_MATCH_DROP_PCT"
...
try_hard_feedback() {
  ...
  SOURCE_RUN_DIR="$failed_dir" \
    ...
    TEACHER_TOP_CE_WEIGHT="$TEACHER_TOP_CE_WEIGHT" \
    RERANK_DEDUPE_SFEN="$RERANK_DEDUPE_SFEN" \
    RERANK_ALLOW_MEAN_REGRET_INCREASE_CP="$RERANK_ALLOW_MEAN_REGRET_INCREASE_CP" \
    RERANK_ALLOW_P90_REGRET_INCREASE_CP="$RERANK_ALLOW_P90_REGRET_INCREASE_CP" \
    RERANK_ALLOW_P95_REGRET_INCREASE_CP="$RERANK_ALLOW_P95_REGRET_INCREASE_CP" \
    RERANK_ALLOW_BAD_RATIO_INCREASE="$RERANK_ALLOW_BAD_RATIO_INCREASE" \
