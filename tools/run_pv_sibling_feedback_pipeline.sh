...
FEEDBACK_MAX_CANDIDATE_REGRET_CP="${FEEDBACK_MAX_CANDIDATE_REGRET_CP:-0}"
FEEDBACK_MIN_REGRET_DELTA_CP="${FEEDBACK_MIN_REGRET_DELTA_CP:-10}"
FEEDBACK_MAX_REGRET_DELTA_CP="${FEEDBACK_MAX_REGRET_DELTA_CP:-0}"
...
echo "FEEDBACK_MAX_CANDIDATE_REGRET_CP=$FEEDBACK_MAX_CANDIDATE_REGRET_CP"
echo "FEEDBACK_MIN_REGRET_DELTA_CP=$FEEDBACK_MIN_REGRET_DELTA_CP"
echo "FEEDBACK_MAX_REGRET_DELTA_CP=$FEEDBACK_MAX_REGRET_DELTA_CP"
