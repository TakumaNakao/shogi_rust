...
EXPLICIT_STUDENT_MARGIN_WEIGHT="${EXPLICIT_STUDENT_MARGIN_WEIGHT:-0}"
...
echo "REPLAY_WEIGHT=$REPLAY_WEIGHT CURRENT_TOP_MARGIN_WEIGHT=$CURRENT_TOP_MARGIN_WEIGHT LISTWISE_HARD_NEGATIVE_WEIGHT=$LISTWISE_HARD_NEGATIVE_WEIGHT EXPLICIT_STUDENT_MARGIN_WEIGHT=$EXPLICIT_STUDENT_MARGIN_WEIGHT"
...
train_args=(
  ...
  --explicit-student-margin-weight "$EXPLICIT_STUDENT_MARGIN_WEIGHT"
