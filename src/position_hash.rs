...
mod tests {
    ...
    fn test_hash_consistency() {
        ...
        assert_eq!(
            hash1, hash2,
            "Hash for the same position should be consistent"
        );
    }
    ...
    fn test_hash_changes_on_side_to_move() {
        ...
        pos_black_turn.do_move(Move::Normal {
            from: Square::new(7, 7).unwrap(),
            to: Square::new(7, 6).unwrap(),
            promote: false,
        });
        ...
        assert_ne!(
            ...
            "Hash should change when side to move changes"
        );
    }
    ...
    fn test_hash_changes_on_hand_piece() {
        ...
        assert_ne!(
            ...
            "Hash should change when a piece is added to hand"
        );
    }
    ...
    fn test_hash_repetition() {
        ...
        assert_eq!(
            ...
            "Hash must be the same for the same sequence of moves"
        );
