...
### Holdout v2 provenance

The v2 holdout is frozen only after implementation and thresholds are complete.
The source pool was streamed from
`data/wdoor/search_quality_phase0/pools/holdout.jsonl` with the union of the
old three holdout suites' 253 `source_game_key` values and 371 SFEN values
excluded. The input contained 50,718 non-empty rows; 15,461 rows were removed
by game key and none by an additional SFEN match, leaving 35,257 rows. Its
SHA-256 is
`0ddd55724226c54615365957f309c7a4dc3feb597e0dbdb4c500c6086b3bca80`.

The mate target contains 42 real proofs from that pool and 58 synthetic proofs.
Synthetic positions were generated by `mate_synthetic_augment` from the v2
pool using ChaCha8 seed `20260714`, one to three legal random plies, and no
evaluation or external engine. The synthetic generation input SHA-256 is
`cc090b47bee5e45f79846907e07149a0db9bb0179fddfadac281f698bd029e8d`; the
80,000-row synthetic output SHA-256 is
`ee63aaae224c4f3d1ed3d367654ac48b02759c8ff9f3ccd8db9112ea1b3b8e36`.
Every synthetic row carries the original game key plus a unique
`#synthetic-v2-*` marker and is revalidated by the same 1/3/5/7-ply full-width
mate oracle. The final 100-row mate source pool SHA-256 is
`1fb0ea6a6a7ad081e11d5356b2bc0babb489f667b113746c1d7caa27d22c1cee`.

The large source and synthetic pools are provenance artifacts and should be
stored outside repository history. Keep the suite JSONL, sidecars, and their
